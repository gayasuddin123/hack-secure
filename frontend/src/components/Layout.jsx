				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  "
							...
							<div className="flex flex-col">
								...
								<span className="text-xs text-red-500 tracking-widest">
									2026
								</span>
							</div>
						</NavLink>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
						...
						<div className="lg:col-span-2">
							...
							<p className="text-gray-400 max-w-md mb-6">
								A national-level hackathon focusing on secure
								web innovation and artificial intelligence. Join
								us for an unforgettable experience of coding,
					...
					<div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
						<p className="text-gray-500 text-sm">
							© 2026 Hack Secure. All rights reserved. Organized
							by Codevirus Security Pvt. Ltd.
						</p>
